...
namespace PCI {
    ...
    const char* MassStorageControllerSubclassName(uint8_t subclassCode){
        ...
        case 0x08:
            return "Non-Volatile Memrory Controller";
        case 0x80:
            return "Other";
        }

        return to_hstr(subclassCode);
    }
